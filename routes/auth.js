...
router.post('/register',cors(),
  [
    ...
    body('username').trim().isAlphanumeric().withMessage('the username must be alphanumeric').isLength({min: 6 }).withMessage('the username must contain at least 6 characters')
  ],
